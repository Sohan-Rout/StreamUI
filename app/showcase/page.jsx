...
const LazyPreview = ({ slug }) => {
  ...
  return Component ? (
    ...
    <div className="w-full py-12 flex justify-center items-center">
      <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-neutral-600" />
    </div>
  );
};
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <aside className="md:w-52 w-full">
              ...
              <div className="space-y-2">
                <p className="text-sm font-semibold text-neutral-600">Filter By Sections</p>
                <ul className="space-y-2 mt-2">
                  {["pricing", "featured", "schedule"].map((tag) => (
                    <li key={tag}>
                      <button
                        onClick={() => {
                          setSearch(tag);
                        ...
                        className="w-full text-left px-3 py-2 text-sm rounded-md bg-neutral-100 hover:bg-neutral-200 border border-neutral-300 text-neutral-700 transition"
                      >
