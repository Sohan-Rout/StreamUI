...
export const props = [
  {
    ...
    required: false,
    defaultValue: "null",
    description: "Initial date to highlight and focus on when the calendar loads.",
  },
  {
    name: "onDateSelect",
    type: "(date: Date) => void",
  ...
  },
  {
    ...
    required: false,
    defaultValue: '""',
    description: "Optional utility classes to style or position the calendar layout.",
  }
];