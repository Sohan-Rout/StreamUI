...
export const implementation = `<PricingCard name = "Pro" price="$9/mo" description="Access all advanced components and premium support." features={["All Starter Features", "Animated Components", "Priority Support", "Component Requests"]} notIncluded={["Team Collaboration"]} highlight={true} />`
...
export const props = [
      ...
      },
      {
        ...
        type: "string",
        required : false,
        defaultValue : "Access all advanced components and premium support.",
        description : ""
      },
      {
        name : "features",
        type : "string",
        required : false,
        defaultValue : "All Starter Features, Animated Components, Priority Support, Component Requests",
        description : ""
      },
      {
        name: "notIncluded",
